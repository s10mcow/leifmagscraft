...
export function saveWorld() {
    const saveData = {
        ...
        etherWorld: state.voidWorld.length > 0 ? rleEncode(state.voidWorld) : null,
        ...
        etherBgWorld: state.voidBgWorld.length > 0 ? rleEncode(state.voidBgWorld) : null,
        ...
        etherReturnX: state.voidReturnX,
        etherReturnY: state.voidReturnY,
        etherReturnDim: state.voidReturnDim || 'overworld',
...
export function loadWorld(worldName) {
    ...
    setTimeout(function() {
        try {
            ...
            state.inTheVoid = data.inTheVoid || false;
            if (state.inTheVoid) {
