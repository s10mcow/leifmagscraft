        ...
        switch (state.gameState) {
            ...
            case "playing":
                ...
                while (accumulator >= FIXED_DT) {
                    ...
                    if (state.inTheVoid) state.cachedDayBrightness = 0.5;
                    ...
                    if (!state.inNether && !state.inWasteland && !state.inVoid && !state.inPossum && !state.inTheVoid) state.timeOfDay = (state.timeOfDay + DAY_CYCLE_SPEED) % 1;
                }
